...
\renewcommand{\paragraph}{$if(number-sections.paragraph)$$number-sections.paragraph$$else$\arabic{paragraph}$endif$}
\renewcommand{\subparagraph}{$if(number-sections.subparagraph)$$number-sections.subparagraph$$else$\alpha{subparagraph}$endif$}
$else$
...
{$if(title-format.paragraph)$$title-format.paragraph$$else$\hspace{1em}\fontsize{14}{16}\selectfont\rmfamily$endif$}
{\paragraph}{1em}{}

\titleformat{\subparagraph}
{$if(title-format.subparagraph)$$title-format.subparagraph$$else$\hspace{2em}\fontsize{14}{16}\selectfont\rmfamily$endif$}
{\subparagraph}{1em}{}
...
\vspace{2cm}
$if(subtitle)${\fontsize{14}{1}\selectfont $subtitle$}  \\$endif$
$if(subject)${\fontsize{14}{1}\selectfont $subject$}  \\$endif$
$if(major)${\fontsize{14}{1}\selectfont Ngành: $major$}  \\$endif$
\vspace{2cm}
$if(instructors)${\fontsize{14}{1}\selectfont\textbf{
\begin{tabular}{ll}
Người hướng dẫn: $for(instructors)$ & $instructors$$sep$ \\ \\[0.25em] $endfor$
\end{tabular}
}}
\\$endif$
\vspace{2cm}
...
\centering
\vspace*{3mm}
{\fontsize{13}{1}\selectfont $university$ \\
...
\begin{tabular}{ll}
$for(author)$$author.name$ \\ \\[0.25em] $endfor$
\end{tabular}
}}
\\
\vspace{2cm}
...
{\fontsize{14}{1}\selectfont \textbf{
\begin{tabular}{ll}
Cán bộ hướng dẫn: $for(instructors)$ & $instructors$$sep$ \\ \\[0.25em] $endfor$
\end{tabular}
}}
\vfill
\centering
